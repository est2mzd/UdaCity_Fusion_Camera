                      ...
                      std::vector<cv::DMatch> kptMatches, double frameRate, double &TTC)
{
    ...
    std::cout << "1. meanDistRatio = " << meanDistRatio << " / TTC = " << TTC << std::endl;
    ...
    std::cout << "2. medianDistRatio = " << medianDistRatio << " / TTC = " << TTC << std::endl;
    ...
    std::cout << "3. medDistRatio = " << medDistRatio << " / TTC = " << TTC << std::endl;
}
